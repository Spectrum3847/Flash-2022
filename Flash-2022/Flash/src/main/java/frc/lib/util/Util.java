 ...
 */
public class Util {
    private static double minBatteryVoltage = 11.8;
	 ...
	 * Should return true if robot is disabled and voltage is less than minBatteryVoltage
	 ******************************************************************************/
	public static boolean changeBattery () {
		return (Robot.s_robot_state == Robot.RobotState.DISABLED && RobotController.getInputVoltage() < minBatteryVoltage);
	}
